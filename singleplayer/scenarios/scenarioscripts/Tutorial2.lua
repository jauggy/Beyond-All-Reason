...
local function updateObjectiveUI() Spring.SendLuaUIMsg("currentObjective|"..currentObjective) end
local function giveScenarioHint() Spring.SendLuaUIMsg("scenarioHint|"..scenarioHint) end
...
function gadget:UnitUnloaded(unitID, unitDefID, unitTeam, transportID, transportTeam)
    ...
    setStage("stage1_B2")
    currentObjective = "Destroy the Light Laser Turrets (LLTs) so you can begin building your base. \nGrunt’s high line of sight can be used to spot. "
...
function gadget:GameFrame(frameNum) --fires off every frame
    ...
    updateObjectiveUI()
        ...
        local enableAITrigger = Spring.GetUnitsInRectangle(0, 4500, 1000, 5500, 0)
        ...
        local radarPosFoundCheck = Spring.GetUnitsInRectangle(1769, 6992, 2000, 8188, 0)
